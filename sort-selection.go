/*
 * 選択ソートを採用したソートアルゴリズム
 * 選択ソートによりソートした配列とソートパッケージによりソートした配列を比較し、ソート結果の成否を表示する
 *
 * ＜出力例＞
 ...
 * Sort by selection sort: [1 1 2 3 5 5 8 11 11 13 14 16 18 19 19 19 20 21 22 23 24 25 25 27 27 28 28 29 32 32 35 36 36 38 38 38 41 41 41 42 42 46 46 46 47 48 51 52 53 54 55 56 56 57 58 58 58 60 61 62 66 66 66 67 67 72 72 72 72 74 74 78 80 81 84 84 84 86 86 86 86 87 87 88 89 90 90 91 91 92 93 95 96 96 96 96 98 98 99 99]
...
func main() {
	...
	fmt.Println("Sort by selection sort:", sortedList)
...
/*
 * ソート前の配列を受け取り、選択ソートによりソートされた結果を返す関数
 */
func selectionSort(list [100]int) [100]int {
	for i := 0; i < len(list); i++ {
		min := i
		...
		list[i], list[min] = swap(list[i], list[min])
	}
	return list
}
